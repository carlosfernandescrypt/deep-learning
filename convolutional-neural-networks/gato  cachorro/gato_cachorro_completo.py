...
#passando uma imagem pra rede neural identificar

imagem_teste = image.load_img('/content/drive/My Drive/dataset/test_set/gato/cat_3500.jpg', target_size = (64,64))
imagem_teste = image.img_to_array(imagem_teste) #transforma a imagem em float32, deixando assim os dados da imagem
imagem_teste /= 255 #coloca os numeros entre 0 e 1
imagem_teste = np.expand_dims(imagem_teste, aixs = 0) #vai transforma a imagem em um formato do tensorflow, na sequencia = (1, 64, 64, 3), se fosse mais imagems, teria que modificar o 0
previsao = classificador.predict(imagem_teste)
previsao = (previsao > 0.5) #onde true é gato e false é cachorro
if previsao == True:
  print('gato')
else:
  print('cachorro')
base_treinamento.class_indices #mostra se cachorro e gato é 0 ou 1