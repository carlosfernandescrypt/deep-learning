...
#escolhendo  os melhores parametros para a maquina
...
def criarRede(optmizer, loss, kernel_initializer, activation, neurons): #ele vai achar as melhores maneiras para esses parametros 
  ...
  classificador.compile(optimizer = optmizer, loss = loss, metrics = ['binary_accuracy'])
  return classificador

classificador = KerasClassifier(build_fn = criarRede)
parametros = {'batch_size': [10, 30], 'epochs': [50, 100], 'optmizer': ['adam', 'sgd'], 'loss': ['binary_crossentropy', 'hinge'], 
